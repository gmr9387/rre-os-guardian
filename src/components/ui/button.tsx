  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        danger: "bg-danger text-danger-foreground hover:bg-danger/90 shadow-lg hover:shadow-danger/25",
        ...
        execute: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold shadow-lg hover:shadow-primary/40 hover:scale-[1.02] active:scale-[0.98]",
        kill: "bg-danger/20 text-danger border-2 border-danger hover:bg-danger hover:text-danger-foreground font-bold uppercase tracking-wider",
      },
      size: {
